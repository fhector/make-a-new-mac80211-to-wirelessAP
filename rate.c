...
static char *ieee80211_default_rc_algo = CONFIG_MAC80211EXT_RC_DEFAULT;
...
ieee80211_rate_control_ops_get(const char *name)
{
	...
	if (!ops && strlen(CONFIG_MAC80211EXT_RC_DEFAULT))
		ops = ieee80211_try_rate_control_ops_get(CONFIG_MAC80211EXT_RC_DEFAULT);
